...
def run_simulations(list_gene_sequences, list_number_spots, list_target_channels_proteins, list_target_channels_mRNA,list_diffusion_coefficients,list_label_names, list_elongation_rates, list_initation_rates, frame_selection_empty_video = 'linear_interpolation',simulation_time_in_sec = 100,step_size_in_sec = 1,save_as_tif = 0,save_dataframe = 0,create_temp_folder = 0, spot_size = spot_size, number_cells=1,intensity_scale_ch0=intensity_scale,intensity_scale_ch1=intensity_scale,intensity_scale_ch2=intensity_scale):
  ...
  for i in range (0,number_cells ):
    ...
    _, single_dataframe_simulated_cell,list_ssa = rsp.SimulatedCellMultiplexing(inial_video,list_gene_sequences,list_number_spots,list_target_channels_proteins,list_target_channels_mRNA, list_diffusion_coefficients,list_label_names,list_elongation_rates,list_initation_rates,simulation_time_in_sec,step_size_in_sec,save_as_tif, save_dataframe, saved_file_name,create_temp_folder, mask_image=mask_image, cell_number =i,frame_selection_empty_video=frame_selection_empty_video,spot_size =spot_size, intensity_scale_ch0=intensity_scale_ch0, intensity_scale_ch1=intensity_scale_ch1, intensity_scale_ch2=intensity_scale_ch2, dataframe_format=dataframe_format).make_simulation()
