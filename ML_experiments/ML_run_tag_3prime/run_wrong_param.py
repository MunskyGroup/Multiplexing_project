# -*- coding: utf-8 -*-
"""
Created on Mon Aug 29 15:45:36 2022
...
model_dir = './ML_run_320_5s_wfreq/y_predicted_keki/'
...
with tqdm.tqdm(range(100)) as pbar:
    for i in range(10):
        ...
        sub_label_grid = []
        for j in range(10):
            data_file = 'ki_ke_sweep_5000spots_%s_%s.csv'%(kis[i],kes[j])
        ...
        for k in range(10):
            ...
            for i in range(10):
                for j in range(10):
                    ...
                    y_pred[m,k,i,j,:] = y_hat
                    acc_grid[m,k,i,j,0] = accuracy_score(label_grid[i][j], y_hat)
