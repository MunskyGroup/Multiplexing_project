...
##############################################################################
# Global setup
# This file makes runs all machine learning experiments in the paper:
#    
...
#
# !!! WARNING !!! 
# If not run in debug mode, THIS WILL TRAIN OVER 1000 CLASSIFIERS AND WILL TAKE
# 70 GB OF DISK SPACE 
##############################################################################
...
DEBUG = 0 # if true, all codes run with no classifiers trained.

training_data_size = 1  # Figure 2
long_intensity = 1      # Figure 4 / Figure S2
parsweeps = 1           # Figure 5 / Figure 6
supplemental_sweeps = 1 # Figure S4
tagging = 1             # Figure 8
multiplexing = 1        # Figure 9
photobleaching = 1      # Figure S3
