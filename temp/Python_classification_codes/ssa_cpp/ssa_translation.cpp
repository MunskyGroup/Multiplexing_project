...
static PyObject *__pyx_pw_15ssa_translation_1run_SSA(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_result,&__pyx_n_s_ribtimes,&__pyx_n_s_coltimes,&__pyx_n_s_col_x,&__pyx_n_s_col_t,&__pyx_n_s_kelong,&__pyx_n_s_frap_result,&__pyx_n_s_t_array,&__pyx_n_s_kbind,&__pyx_n_s_kcompl,&__pyx_n_s_FRAP,&__pyx_n_s_Inhibitor,&__pyx_n_s_inhibit_time,&__pyx_n_s_seed,&__pyx_n_s_nribs,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ribtimes)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 1); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_coltimes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 2); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_col_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 3); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_col_t)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 4); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_kelong)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 5); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_frap_result)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 6); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_t_array)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 7); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_kbind)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 8); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_kcompl)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 9); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_FRAP)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 10); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Inhibitor)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 11); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_inhibit_time)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 12); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 13:
        if (likely((values[13] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_seed)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 13); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 14:
        if (likely((values[14] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nribs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, 14); __PYX_ERR(0, 16, __pyx_L3_error)
        }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 15, 15, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L3_error:;
  ...
  __pyx_r = __pyx_pf_15ssa_translation_run_SSA(__pyx_self, __pyx_v_result, __pyx_v_ribtimes, __pyx_v_coltimes, __pyx_v_col_x, __pyx_v_col_t, __pyx_v_kelong, __pyx_v_frap_result, __pyx_v_t_array, __pyx_v_kbind, __pyx_v_kcompl, __pyx_v_FRAP, __pyx_v_Inhibitor, __pyx_v_inhibit_time, __pyx_v_seed, __pyx_v_nribs);
 ...
 *     I need to write this.
 */
  __pyx_tuple__10 = PyTuple_Pack(22, __pyx_n_s_result, __pyx_n_s_ribtimes, __pyx_n_s_coltimes, __pyx_n_s_col_x, __pyx_n_s_col_t, __pyx_n_s_kelong, __pyx_n_s_frap_result, __pyx_n_s_t_array, __pyx_n_s_kbind, __pyx_n_s_kcompl, __pyx_n_s_FRAP, __pyx_n_s_Inhibitor, __pyx_n_s_inhibit_time, __pyx_n_s_seed, __pyx_n_s_nribs, __pyx_n_s_Nt, __pyx_n_s_N, __pyx_n_s_ribtimesize, __pyx_n_s_coltimesize, __pyx_n_s_fNt, __pyx_n_s_cNt, __pyx_n_s_colNp); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(15, 0, 22, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_ssa_translation_pyx, __pyx_n_s_run_SSA, 16, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
