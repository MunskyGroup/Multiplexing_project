...
#  returns the classifier and accuracy for a given condition.
#
#  Arguments:
#    
...
# generate the training, testing, and witheld data.
...
###############################################################################
# DEFINE THE MODEL TYPE HERE, freq should always be used for the paper for now
###############################################################################

# model architecture for frequency and intensity classficiation
if test_type == 'freq':
