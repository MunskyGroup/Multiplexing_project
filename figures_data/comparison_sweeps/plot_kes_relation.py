...
plt.semilogx([1.4612937433722164, 1.4612937433722164],[0.4,1.1],'b--', label='_nolegend_')
plt.semilogx([.08,86],[.8,.8],'k-', label='_nolegend_')
...
plt.annotate('1.46', xy=(1.6, .5), xytext=(4, .6),
...
plt.xlabel('$k_{elongation, P300}$ /$k_{elongation, KDM5B}$')
plt.ylabel('Test Accuracy')
plt.title(r'mRNAs with differing $k_{elongation}$ rates dataset')
plt.legend(['64 frames, 5s FR', '128 frames, 5s FR','1500 frames, 2s FR'])
plt.xlim([.08,8])

plt.ylim([0.45,1.05])
plt.savefig('./ke_relation.svg')